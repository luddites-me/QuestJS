...
QuestJs._create.createRoom("lounge", {
  ...
  west:new QuestJs._create.Exit("lift", { isLocked:function() { return !QuestJs._w.reactor_room.reactorRunning }}),
  eventPeriod:1,
  eventActive:true,
  eventCount:0,
  eventScript:function() {
    ...
    switch (this.eventCount) {
      ...
      case 2:
        ...
        tmsg("For completeness, I will also mention TRANSCRIPT (or just SCRIPT), which will record your game session, and can be useful when testing someone's QuestJs._game. You can also use BRIEF, TERSE and VERBOSE to control how often room descriptions are shown, but I suggest we keep it VERBOSE for this tutorial.")
        QuestJs._io.ambient()
        break
      case 3:
...
QuestJs._create.createItem("kitchen_door", QuestJs._templates.LOCKED_DOOR([], "lounge", "kitchen"), {
...
QuestJs._create.createRoom("basement", {
  ...
  west:new QuestJs._create.Exit('secret_passage', {isHidden:function() { return !QuestJs._w.crates.moved || (!QuestJs._w.light_switch.switchedon && !QuestJs._w.flashlight.switchedon); } }),
  ...
  eventScript:function() {
    ...
    if (!QuestJs._w.flashlight.switchedon && QuestJs._w.light_switch.switchedon && !this.flag2) hint.now('getAll')
...
QuestJs._create.createItem("box", READABLE(), QuestJs._templates.CONTAINER(true), QuestJs._templates.LOCKED_WITH([]), {
  examine:function() {
...
QuestJs._create.createRoom("laboratory", {
  ...
  north:new QuestJs._create.Exit("reactor_room", {use:function(char) {
    if (char === QuestJs._w.me && QuestJs._w.lab_door.closed) return QuestJs._io.falsemsg("The door is too heavy for you to move.")
...
QuestJs._create.createRoom("reactor_room", {
  ...
  eventPeriod:1,
  eventIsActive:function() { return QuestJs._w.me.loc === "reactor_room" },
  countdown:6,
  eventScript:function() {
    this.countdown--
...
QuestJs._create.createRoom("office", {
  ...
  west:new QuestJs._create.Exit("lift", { use:function() {
    if (QuestJs._w.office.lift_exit_locked) return QuestJs._io.falsemsg("The lift door is closed. You suspect Professor Kleinscope is in he lift and on his way up right now.")
  ...
  out:new QuestJs._create.Exit("garden", {
    use:function() {
      if (!QuestJs._w.office_window.smashed) QuestJs._io.falsemsg("There is a pane of glass in the way.")
    ...
    isHidden:function() { return !QuestJs._w.office_window.smashed },
  }),
  afterFirstEnter:function() {
...
QuestJs._create.createItem("office_window", {
  ...
  throwThrough:function(item) {
    ...
    if (item.tiedTo1 && item.tiedTo2) falsedmsg("The rope is tied to both {nm:obj1:the} and {nm:obj2:the}; which end were you hoping to throw out?", {obj1:QuestJs._w[rope.tiedTo1], obj2:QuestJs._w[rope.tiedTo2]})
    ...
    if (!QuestJs._w.Professor_Kleinscope.flag) {
      ...
      QuestJs._io.askQuestion("PIN?", function(result) {
        if (result === QuestJs._w.computer.code) {
          ...
          if (QuestJs._w.old_newspaper.loc !== 'me' && QuestJs._w.rope.isAtLoc('me') && QuestJs._w.old_newspaper.loc !== 'office' && !QuestJs._w.rope.isAtLoc('office')) {
          ...
          else if (QuestJs._w.old_newspaper.loc !== 'me' && QuestJs._w.old_newspaper.loc !== 'office') {
