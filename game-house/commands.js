QuestJs._commands.unshift(
  new QuestJs._command.Cmd('knock_on_door', {
    regex: /^knock$/,
...
QuestJs._commands.unshift(
  new QuestJs._command.Cmd('post_letter', {
...
QuestJs._commands.unshift(
  new QuestJs._command.Cmd('climb_telescope', {
    regex: /^climb$/,
    objects: [{ ignore: true }, { scope: QuestJs._parser.isHere }],
    // script:
    //         do (telescope, "climb")
...
QuestJs._commands.unshift(
  new QuestJs._command.Cmd('climb_out', {
    regex: /^climb$/,
    objects: [{ ignore: true }, { scope: QuestJs._parser.isHere }],
    // script:
...
QuestJs._commands.unshift(
  new QuestJs._command.Cmd('fix_wire', {
...
QuestJs._commands.unshift(
  new QuestJs._command.Cmd('fix_wire_to_spike', {
...
QuestJs._commands.unshift(
  new QuestJs._command.Cmd('bootcheat', {
    regex: /^bootcheat$/,
    objects: [{ ignore: true }, { scope: QuestJs._parser.isHere }],
    script() {
...
QuestJs._commands.unshift(
  new QuestJs._command.Cmd('bootshrink', {
    regex: /^bootshrink$/,
    objects: [{ ignore: true }, { scope: QuestJs._parser.isHere }],
    // script:
    //     if (EndsWith(QuestJs._game.version, "beta")) {
