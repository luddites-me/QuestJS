...
map.init = function () {
  ...
  map.layers = [
    // rooms on other levels
    {
      ...
      attrs:
        'stroke="' +
        QuestJs._settings.mapBorderColour +
        '" stroke-width="1" fill="' +
        QuestJs._settings.mapLocationColour +
    ...
    // exits
    {
      ...
      attrs:
        'style="stroke:' +
        QuestJs._settings.mapExitColour +
        ';stroke-width:' +
        QuestJs._settings.mapExitWidth +
        'px;fill:' +
        QuestJs._settings.mapExitColour +
        '"',
    },
    ...
    // labels
    {
      name: 'labels',
      attrs:
        'pointer-events="none" fill="' +
        QuestJs._settings.mapLabelColour +
        '" text-anchor="middle"',
    },
  ];
};
...
map.mapDrawLabelDefault = function (o, loc) {
  ...
  if (QuestJs._settings.mapLabelRotate)
    s +=
      '" transform="rotate(' +
      QuestJs._settings.mapLabelRotate +
      ',' +
      loc.mapX +
      ',' +
