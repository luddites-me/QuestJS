...
const settings = {
  ...
  isHeldNotWorn:function(item) {
    return item.isAtLoc(QuestJs._game.player.name, world.SIDE_PANE) && world.ifNotDark(item) && !item.getWorn();
  },
  isHere:function(item) {
    return item.isAtLoc(QuestJs._game.player.loc, world.SIDE_PANE) && world.ifNotDark(item);
  },
  ...
  libraries:["_saveload", "_text", "_io", "_command", "_defaults", "_templates", "_world", "_npc", "_parser", "_commands"],  // QuestJs._util already loaded
  customLibraries:[],
...
settings.inventoryPane = [
  {name:'Items Held', alt:'itemsHeld', test:settings.isHeldNotWorn, getLoc:function() { return QuestJs._game.player.name; } },
  {name:'Items Worn', alt:'itemsWorn', test:settings.isWorn, getLoc:function() { return QuestJs._game.player.name; } },
  {name:'Items Here', alt:'itemsHere', test:settings.isHere, getLoc:function() { return QuestJs._game.player.loc; } },
]
