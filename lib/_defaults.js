...
const DEFAULT_OBJECT = {
  pronouns:QuestJs.LANG.pronouns.thirdperson,
...
const DEFAULT_ROOM = {
  ...
  templatePreSave:function() {
    /*for (let i = 0; i < QuestJs.LANG.exit_list.length; i++) {
      const dir = QuestJs.LANG.exit_list[i].name;
  ...
  getReverseExit:function(dir) {
    const reverseDir = QuestJs.LANG.exit_list.find(el => el.name === dir)
    const dest = this[dir]
