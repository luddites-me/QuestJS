  ...
  scopeSnapshot(visible) {
    ...
    if (this.getContents) {
      ...
      if (
        ...
        this.scopeStatusForRoom !== QuestJs._world.REACHABLE &&
        this !== QuestJs._game.player
      ) {
...
QuestJs._defaults.DEFAULT_ROOM = {
  ...
  getRandomExit(options) {
    return QuestJs._random.fromArray(this.getExits(options));
  },
  ...
  templatePreSave() {
    /* for (let i = 0; i < QuestJs._lang.exit_list.length; i += 1) {
