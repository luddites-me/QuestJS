...
io.writeExit = function(n) {
  ...
  document.write('" onclick="io.clickExit(\'' + QuestJs._lang.exit_list[n].name + '\')">')
  document.write(settings.symbolsForCompass ? io.displayIconsCompass(QuestJs._lang.exit_list[n]) : QuestJs._lang.exit_list[n].abbrev);
