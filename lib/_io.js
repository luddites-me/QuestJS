...
QuestJs._IO.typewriterEffect = function(data) {
  ...
  setTimeout(QuestJs._IO.forceOutputFromQueue, settings.textEffectDelay)
}
...
QuestJs._IO.resizePanesListener = window.matchMedia('(max-width: ' + settings.panesCollapseAt + 'px)')
QuestJs._IO.resizeMapImageListener = window.matchMedia('(max-width: ' + settings.mapAndImageCollapseAt + 'px)')
...
QuestJs._IO.writeExit = function(n) {
  ...
  document.write(settings.symbolsForCompass ? QuestJs._IO.displayIconsCompass(QuestJs._lang.exit_list[n]) : QuestJs._lang.exit_list[n].abbrev);
