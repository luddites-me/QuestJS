...
tp.text_processors.money = function(arr, params) {
  ...
  if (obj.loc === game.player.name && obj.getSellingPrice) {
    return QuestJs._tools.displayMoney(obj.getSellingPrice(game.player))
  }
  if (obj.loc === game.player.name && obj.getBuyingPrice) {
    return QuestJs._tools.displayMoney(obj.getBuyingPrice(game.player))
  }
  if (obj.getPrice) {
...
tp.text_processors.transitDest = function(arr, params) {
  ...
  return QuestJs._lang.getName(w[destName], {capital:true})
};
...
tp.text_processors.objects = function(arr, params) {
  const listOfOjects = QuestJs._scope.scopeHereListed();
  return QuestJs._tools.formatList(listOfOjects, {article:QuestJs._consts.INDEFINITE, lastJoiner:QuestJs._lang.list_and, modified:true, nothing:QuestJs._lang.list_nothing, loc:game.player.loc});
}
