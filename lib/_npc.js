...
const NPC = function(isFemale) {
  ...
  res.QuestJs._io.msg = function(s, params) {
...
const npc_utilities = {
  talkto:function() {
    ...
    if (settings.dropdownForConv) {
      showDropDown(QuestJs._lang.speak_to_menu_title(this), topics, function(result) {
      ...
      showMenu(QuestJs._lang.speak_to_menu_title(this), topics, function(result) {
        if (result !== QuestJs._lang.never_mind) {
          result.runscript();
        }
      });
