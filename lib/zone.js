...
export const zoneExit = function(char, dir) {
...
export const ZONE = function(defaultToBlocked) {
  const res = {
    exits:[],
    zone:true,
...
export const ZONE_BORDER = function(loc) {
  const res = {
    zoneBorder:true,
    zone:loc,
...
export const ZONE_ITEM = function(loc, x, y) {
  const res = {positionX:x, positionY:y, zoneElsewhere:loc,};
  return res;
}

export const ZONE_FEATURE = function(loc, x, y, range, adjacent) {
  const res = {
