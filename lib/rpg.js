...
export class MetaSkill extends Skill {
  constructor(name, data) {
    super(name, data)
    this.meta = true
  }
...
export const defaultSkill = new Skill("Basic attack", {
  icon:"sword1",
...
export const RPG_PLAYER = function() {
  const res = PLAYER();
...
export const RPG_NPC = function(female) {
...
export const RPG_CORPOREAL_UNDEAD = function(female) {
...
export const RPG_NON_CORPOREAL_UNDEAD = function(female) {
...
export const WEAPON = function(damage) {
...
export const LIMITED_USE_WEAPON = function(damage, ammo) {
...
export const SHIELD = function(bonus) {
  const res = $.extend({}, EQUIPPABLE())
  res.shield = true
...
export const SPELLBOOK = function(list) {
  const res = $.extend({}, TAKEABLE_DICTIONARY)
  res.spellbook = true
