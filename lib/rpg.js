...
class Attack {
  ...
  resolve(target, isPrimary, count) {
    ...
    if (this.skill.automaticSuccess) {
      QuestJs._io.msg(processText(this.skill.targetText, {skill:this.skill, attacker:this.attacker, target:target}), 3)
      ...
      if (this.result < 0) {
        if (isPrimary && this.primaryFailure) {
          QuestJs._io.msg(processText(this.primaryFailure, this), 1)
        }
        else if (!isPrimary && this.secondaryFailure) {
          QuestJs._io.msg(processText(this.secondaryFailure, this), 1)
        }
        else {
      ...
      if (isPrimary && this.primarySuccess) {
        QuestJs._io.msg(processText(this.primarySuccess, this), 1)
      }
      else if (!isPrimary && this.secondarySuccess) {
        QuestJs._io.msg(processText(this.secondarySuccess, this), 1)
      }
      else {
...
QuestJs.npc.agenda.attack = function(npc, arr) {
