...
board.update = function () {
  ...
  for (let i = this.QuestJs._settings.size; i <= 2 * this.QuestJs._settings.size; i += 1) {
  ...
  if (this.QuestJs._settings.compassPane)
    this.map.push(
      board.getCompass(this.QuestJs._settings.compass.x, this.QuestJs._settings.compass.y),
    );
...
board.handleCell = function (x, y) {
  ...
  for (const el of this.QuestJs._settings.getFeaturesAt(x, y)) {
    ...
    if (feature.script) {
      ...
      const y3 = y2 - feature.height + 30.5 - 0.26 * this.QuestJs._settings.cellSize;
...
board.getBase = function () {
  ...
  s += `${
    ...
    this.QuestJs._settings.cosAngle * this.QuestJs._settings.size * this.QuestJs._settings.cellSize
  } `;
...
board.getCoord = function (x, y) {
  const x2 =
    this.QuestJs._settings.cellSize * (x + y) * this.QuestJs._settings.sinAngle +
    this.QuestJs._settings.offsetX;
  const y2 =
    this.QuestJs._settings.height / 2 +
    this.QuestJs._settings.cellSize * (x - y) * this.QuestJs._settings.cosAngle +
    this.QuestJs._settings.offsetY;
  return [x2, y2];
};
