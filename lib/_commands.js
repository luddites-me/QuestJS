...
QuestJs._commands = [
  ...
  new QuestJs._command.Cmd('MetaIntro', {
    script() {
      ...
      if (typeof QuestJs._settings.intro === 'string') {
        ...
        for (const el of QuestJs._settings.intro) QuestJs._io.msg(el);
      }
      return QuestJs._world.SUCCESS_NO_TURNSCRIPTS;
    },
  }),
  new QuestJs._command.Cmd('MetaBrief', {
    script() {
      QuestJs._game.verbosity = QuestJs._world.BRIEF;
  ...
  new QuestJs._command.Cmd('MetaTerse', {
    script() {
      QuestJs._game.verbosity = QuestJs._world.TERSE;
  ...
  new QuestJs._command.Cmd('MetaVerbose', {
    script() {
      QuestJs._game.verbosity = QuestJs._world.VERBOSE;
  ...
  new QuestJs._command.Cmd('MetaUndo', {
    script() {
      ...
      if (QuestJs._game.gameState.length < 2) {
        QuestJs._io.metamsg(QuestJs._lang.undo_not_available);
        return QuestJs._world.FAILED;
      }
      QuestJs._game.gameState.pop();
      const gameState = QuestJs._game.gameState[QuestJs._game.gameState.length - 1];
      QuestJs._io.metamsg(QuestJs._lang.undo_done);
      QuestJs._saveLoad.loadTheWorld(gameState);
      QuestJs._w[QuestJs._game.player.loc].description();
    },
  }),
  ...
  new QuestJs._command.Cmd('MetaRestart', {
    script() {
      QuestJs._io.askQuestion(QuestJs._lang.restart_are_you_sure, (result) => {
  ...
  new QuestJs._command.Cmd('Look', {
    script() {
      ...
      return QuestJs._settings.lookCountsAsTurn
  ...
  new QuestJs._command.Cmd('Inv', {
    script() {
      const listOfOjects = QuestJs._game.player.getContents(QuestJs._world.INVENTORY);
      QuestJs._io.msg(
        `${QuestJs._lang.inventory_prefix} ${QuestJs._tools.formatList(
          listOfOjects,
          {
  ...
  new QuestJs._command.Cmd('Map', {
    script() {
      ...
      const zone = QuestJs._w[QuestJs._game.player.loc];
      if (!zone.zone) {
  ...
  new QuestJs._command.Cmd('Smell', {
    script() {
      if (QuestJs._game.room.onSmell) {
        QuestJs._tools.printOrRun(QuestJs._game.player, QuestJs._game.room, 'onSmell');
      } else {
        QuestJs._io.msg(QuestJs._lang.no_smell, { char: QuestJs._game.player });
      }
      return QuestJs._world.SUCCESS;
    },
  }),
  new QuestJs._command.Cmd('Listen', {
    script() {
      if (QuestJs._game.room.onListen) {
        QuestJs._tools.printOrRun(QuestJs._game.player, QuestJs._game.room, 'onListen');
      } else {
        QuestJs._io.msg(QuestJs._lang.no_listen, { char: QuestJs._game.player });
      }
      return QuestJs._world.SUCCESS;
    },
  }),
    ...
    script() {
      ...
      for (const key in QuestJs._w) {
        if (QuestJs._parser.isForSale(QuestJs._w[key])) {
          const price = QuestJs._w[key].getBuyingPrice(QuestJs._game.player);
          const row = [
            QuestJs._tools.sentenceCase(QuestJs._w[key].getName()),
            QuestJs._world.Money(price),
          ];
          row.push(
            price > QuestJs._game.player.money
              ? '-'
              : `{cmd:buy ${QuestJs._w[key].alias}:${buy}}`,
          );
          l.push(row);
        }
      }
      ...
      QuestJs._io.msg(
        `${current_money}: ${QuestJs._world.Money(QuestJs._game.player.money)}`,
      );
  ...
  new QuestJs._command.Cmd('Examine', {
    npcCmd: true,
    objects: [{ scope: QuestJs._parser.isPresent, multiple: true }],
    defmsg: QuestJs._lang.default_examine,
  }),
  new QuestJs._command.Cmd('LookAt', {
    // used for NPCs
    npcCmd: true,
    attName: 'examine',
    objects: [{ scope: QuestJs._parser.isPresentOrMe }],
    defmsg: QuestJs._lang.default_examine,
  }),
  new QuestJs._command.Cmd('LookOut', {
    npcCmd: true,
    rules: [QuestJs.cmdRules.isHere],
    objects: [{ scope: QuestJs._parser.isPresent }],
    attName: 'lookout',
  ...
  new QuestJs._command.Cmd('Take', {
    npcCmd: true,
    rules: [
      QuestJs.cmdRules.isHereNotHeldAlready,
      QuestJs.cmdRules.canManipulate,
    ],
    objects: [{ scope: QuestJs._parser.isHereOrContained, multiple: true }],
  ...
  new QuestJs._command.Cmd('Drop', {
    ...
    objects: [{ scope: QuestJs._parser.isHeld, multiple: true }],
    defmsg(char, item) {
  ...
  new QuestJs._command.Cmd('Wear2', {
    npcCmd: true,
    rules: [
      QuestJs.cmdRules.isHeldNotWorn,
      QuestJs.cmdRules.isHeld,
      QuestJs.cmdRules.canManipulate,
    ],
    attName: 'wear',
    objects: [{ scope: QuestJs._parser.isHeld, multiple: true }],
    defmsg(char, item) {
      return item.ensemble
        ? QuestJs._lang.cannot_wear_ensemble
        : QuestJs._lang.cannot_wear;
    },
  }),
  ...
  new QuestJs._command.Cmd('Remove', {
    ...
    objects: [{ scope: QuestJs._parser.isWorn, multiple: true }],
    defmsg(char, item) {
      return item.ensemble
        ? QuestJs._lang.cannot_wear_ensemble
        : QuestJs._lang.not_wearing;
    },
  }),
  ...
  new QuestJs._command.Cmd('Purchase', {
    ...
    objects: [{ scope: QuestJs._parser.isForSale }],
  ...
  new QuestJs._command.Cmd('SmellItem', {
    npcCmd: true,
    attName: 'smell',
    objects: [{ scope: QuestJs._parser.isPresent, attName: 'smell' }],
    defmsg: QuestJs._lang.cannot_smell,
  }),
  new QuestJs._command.Cmd('ListenToItem', {
    npcCmd: true,
    attName: 'listen',
    objects: [{ scope: QuestJs._parser.isPresent, attName: 'listen' }],
  ...
  new QuestJs._command.Cmd('SitOn', {
    ...
    attName: 'siton',
    objects: [{ scope: QuestJs._parser.isHere, attName: 'assumePosture' }],
  ...
  new QuestJs._command.Cmd('Use', {
    ...
    script(objects, matches) {
      ...
      if (obj.useDefaultsTo) {
        ...
        if (cmd) {
          const result = cmd.processCommand(
            QuestJs._game.player,
            obj,
            false,
            matches[0][0],
      ...
      this.default(obj, false, QuestJs._game.player);
      return QuestJs._world.FAILED;
    },
  ...
  new QuestJs._command.Cmd('TalkTo', {
    ...
    attName: 'talkto',
    objects: [{ scope: QuestJs._parser.isNpcAndHere }],
    default(item) {
      return QuestJs._io.failedmsg(QuestJs._lang.cannot_talk_to, {
  ...
  new QuestJs._command.Cmd('Say', {
    script(arr) {
      ...
      for (const key in QuestJs._w) {
        if (
          QuestJs._w[key].sayCanHear &&
          QuestJs._w[key].sayCanHear(QuestJs._game.player, arr[0])
        )
          l.push(QuestJs._w[key]);
      }
      l.sort(
      ...
      if (l.length === 0) {
        QuestJs._io.msg(
          QuestJs._lang.say_no_one_here(QuestJs._game.player, arr[0], arr[1]),
        );
        return QuestJs._world.SUCCESS;
      }
      ...
      if (QuestJs._settings.givePlayerSayMsg)
        QuestJs._io.msg(
          `${QuestJs._lang.nounVerb(
            QuestJs._game.player,
            arr[0],
            true,
          )}, '${QuestJs._tools.sentenceCase(arr[1])}.'`,
        );
      for (const chr of l) {
        if (
          chr.sayQuestion &&
          QuestJs._w[chr.sayQuestion].sayResponse(chr, arr[1])
        )
          return QuestJs._world.SUCCESS;
      ...
      if (QuestJs._settings.givePlayerSayMsg) {
        QuestJs._io.msg(
          QuestJs._lang.say_no_response(QuestJs._game.player, arr[0], arr[1]),
        );
      } else {
        QuestJs._io.msg(
          QuestJs._lang.say_no_response_full(QuestJs._game.player, arr[0], arr[1]),
        );
      }
      return QuestJs._world.SUCCESS;
    },
  ...
  new QuestJs._command.Cmd('FillWith', {
    ...
    script(objects) {
      return handleFillWithLiquid(QuestJs._game.player, objects[0][0], objects[1][0]);
    },
  }),
  new QuestJs._command.Cmd('NpcFillWith', {
    ...
    script(objects) {
      ...
      if (!npc.npc)
        return QuestJs._io.failedmsg(QuestJs._lang.not_npc, {
          char: QuestJs._game.player,
          item: npc,
        });
      objects.shift();
  ...
  new QuestJs._command.Cmd('PutIn', {
    ...
    script(objects) {
      return handlePutInContainer(QuestJs._game.player, objects);
    },
  }),
  ...
  new QuestJs._command.Cmd('TakeOut', {
    ...
    script(objects) {
      return handleTakeFromContainer(QuestJs._game.player, objects);
    },
  }),
  ...
  new QuestJs._command.Cmd('GiveTo', {
    ...
    script(objects) {
      return handleGiveToNpc(QuestJs._game.player, objects);
    },
  }),
  ...
  new QuestJs._command.Cmd('PushExit', {
    ...
    cmdCategory: 'Push',
    script(objects) {
      return handlePushExit(QuestJs._game.player, objects);
    },
    objects: [
      { text: true },
  ...
  new QuestJs._command.Cmd('TieTo', {
    ...
    script(objects) {
      return handleTieTo(QuestJs._game.player, objects[0][0], objects[1][0]);
    },
  }),
  ...
  new QuestJs._command.Cmd('Untie', {
    rules: [QuestJs.cmdRules.canManipulate, QuestJs.cmdRules.isHere],
    cmdCategory: 'Untie',
    objects: [{ scope: QuestJs._parser.isHere, attName: 'rope' }],
    script(objects) {
      handleUntieFrom(QuestJs._game.player, objects[0][0]);
    },
  }),
  ...
  new QuestJs._command.Cmd('UntieFrom', {
    ...
    script(objects) {
      handleUntieFrom(QuestJs._game.player, objects[0][0], objects[1][0]);
    },
  }),
  ...
  new QuestJs._command.Cmd('UseWith', {
    ...
    script(objects, matches) {
      ...
      if (obj.useWith) {
        const result = obj.useWith(QuestJs._game.player, obj2);
        return result ? QuestJs._world.SUCCESS : QuestJs._world.FAILED;
      }
      if (obj2.withUse) {
        const result = obj2.withUse(QuestJs._game.player, obj);
        return result ? QuestJs._world.SUCCESS : QuestJs._world.FAILED;
      }
  ...
  new QuestJs._command.Cmd('AskAbout', {
    rules: [QuestJs.cmdRules.canTalkTo],
    script(arr) {
      if (!QuestJs._game.player.canTalk()) return false;
      if (!arr[0][0].askabout)
        return QuestJs._io.failedmsg(QuestJs._lang.cannot_ask_about, {
          char: QuestJs._game.player,
          item: arr[0][0],
          text: arr[2],
        });
  ...
  new QuestJs._command.Cmd('TellAbout', {
    ...
    script(arr) {
      ...
      if (!arr[0][0].tellabout)
        return QuestJs._io.failedmsg(cannot_tell_about, {
          char: QuestJs._game.player,
          item: arr[0][0],
          text: arr[1],
        });
...
if (QuestJs._settings.playMode === 'dev') {
  QuestJs._commands.push(
    new QuestJs._command.Cmd('DebugWalkThrough', {
      objects: [{ text: true }],
      script(objects) {
        if (typeof walkthroughs === 'undefined')
          return QuestJs._io.errormsg('No walkthroughs set');
        ...
        for (const el of wt) {
          if (typeof el === 'string') {
            ...
            QuestJs._settings.walkthroughMenuResponses = Array.isArray(el.menu)
              ? el.menu
              : [el.menu];
  ...
  QuestJs._commands.push(
    new QuestJs._command.Cmd('DebugInspect', {
      script(arr) {
        const item = arr[0][0];
        QuestJs._io.debugmsg(
          `See the console for details on the object ${item.name} (press F12 to QuestJs._world. the console)`,
        );
        QuestJs._log.info(item);
        return QuestJs._world.SUCCESS_NO_TURNSCRIPTS;
      },
      objects: [{ scope: QuestJs._parser.isInWorld }],
    }),
  );

  QuestJs._commands.push(
    new QuestJs._command.Cmd('DebugInspectByName', {
      script(arr) {
        ...
        QuestJs._io.debugmsg(
          `See the console for details on the object ${item_name} (press F12 to QuestJs._world. the console)`,
        );
  ...
  QuestJs._commands.push(
    new QuestJs._command.Cmd('DebugTest', {
      script() {
        if (!QuestJs._settings.tests) {
          ...
          QuestJs._log.info(
            'To activate testing in your game, set QuestJs._settings.tests to true. More details here: https://github.com/ThePix/QuestJS/wiki/Unit-testing'
          );
          return QuestJs._world.SUCCESS_NO_TURNSCRIPTS;
        }
  ...
  QuestJs._commands.push(
    new QuestJs._command.Cmd('DebugInspectCommand', {
      script(arr) {
        debugmsg(`Looking for ${arr[0]}`);
        for (const cmd of QuestJs._commands) {
          if (
            ...
            for (const key in cmd) {
              if (cmd.hasOwnProperty(key)) {
                QuestJs._io.debugmsg(` -= 1${key}: ${cmd[key]}`);
              }
            }
          }
        }
  ...
  QuestJs._commands.push(
    new QuestJs._command.Cmd('DebugListCommands', {
      script(arr) {
        let count = 0;
        for (const cmd of QuestJs._commands) {
          if (!cmd.name.match(/\d$/)) {
            ...
            const npcCmd = QuestJs._commands.find(
              (el) => el.name === `Npc${cmd.name}2`,
            );
            if (npcCmd) s += ' - NPC too';
  ...
  QuestJs._commands.push(
    new QuestJs._command.Cmd('DebugListCommands2', {
      script(arr) {
        let count = 0;
        for (const cmd of QuestJs._commands) {
  ...
  QuestJs._commands.push(
    new QuestJs._command.Cmd('DebugParserToggle', {
      script(arr) {
...
function handleFillWithLiquid(char, vessel, liquid) {
  ...
  if (!vessel.vessel)
    return QuestJs._io.failedmsg(QuestJs._lang.not_vessel, tpParams);
  if (vessel.closed)
    return QuestJs._io.failedmsg(QuestJs._lang.container_closed, tpParams);
  ...
  if (!vessel.isAtLoc(char.name))
    return QuestJs._io.failedmsg(QuestJs._lang.not_carrying, {
      char,
      item: obj,
    });

  return vessel.fill(false, char, liquid)
    ? QuestJs._world.SUCCESS
    : QuestJs._world.FAILED;
}
...
function handlePutInContainer(char, objects) {
  ...
  if (!container.container)
    return QuestJs._io.failedmsg(QuestJs._lang.not_container, {
      char,
      container,
    });
  if (container.closed)
    ...
    if (flag) {
      if (!obj.isAtLoc(char.name)) {
        QuestJs._io.failedmsg(
          QuestJs._tools.prefix(obj, multiple) + QuestJs._lang.not_carrying,
          {
            char,
            item: obj,
          },
        ...
        QuestJs._io.msg(
          QuestJs._tools.prefix(obj, multiple) + QuestJs._lang.done_msg,
        );
        success = true;
      }
    }
  ...
  for (const obj of objects[0]) {
    ...
    if (flag) {
      if (!obj.isAtLoc(container.name)) {
        QuestJs._io.failedmsg(
          QuestJs._tools.prefix(obj, multiple) +
            QuestJs._lang.not_inside(container, obj),
        );
      } else {
...
function handleGiveToNpc(char, objects) {
  ...
  const multiple = objects[0].length > 1 || QuestJs._parser.currentCommand.all;
  if (!npc.npc && npc !== QuestJs._game.player) {
    QuestJs._io.failedmsg(QuestJs._lang.not_npc_for_give, { char, item: npc });
    return QuestJs._world.FAILED;
  }
  for (const obj of objects[0]) {
    let flag = true;
...
function handlePushExit(char, objects) {
  ...
  const tpParams = { char, item: obj, dir };
...
const handleTieTo = function (char, rope, obj2) {
  if (!rope.rope)
    return QuestJs._io.failedmsg('You cannot attach that to anything.', {
      rope,
    });
  if (!obj2.attachable)
    return QuestJs._io.failedmsg(
      'That is not something you can {rope.attachVerb} {nm:rope:the} to.',
      { rope },
    );

  if (rope.tiedTo1 === obj2.name)
    return QuestJs._io.failedmsg('It already is.');
  if (rope.tiedTo2 === obj2.name)
    return QuestJs._io.failedmsg('It already is.');
  if (rope.tiedTo1 && rope.tiedTo2)
    return QuestJs._io.failedmsg(
      'It is already {rope.attachedVerb} to {nm:obj1:the} and {nm:obj12:the}.',
      {
        rope: QuestJs._w[rope.tiedTo1],
        obj1: QuestJs._w[rope.tiedTo2],
        obj2: QuestJs._w[rope.tiedTo2],
      },
    );

  QuestJs._io.msg(
    `{nv:char:${rope.attachVerb}:true} {nm:rope:the} to {nm:obj2:the}.`,
    {
      char,
      rope,
      obj2,
...
const handleUntieFrom = function (char, rope, obj2) {
  if (rope !== QuestJs._w.rope)
    return QuestJs._io.failedmsg(
      'You cannot attach that to - or detach it from - anything.',
      {
        rope,
      },
    );
  if (obj2 === undefined) {
    ...
    if (!rope.tiedTo1 && !rope.tiedTo2)
      return QuestJs._io.failedmsg(
        '{nv:rope:be:true} not {rope.attachedVerb} to anything.',
        {
          rope,
        },
      );
    if (rope.tiedTo1 && !rope.tiedTo2) {
      ...
      QuestJs._w[rope.tiedTo1].isHere() &&
      !QuestJs._w[rope.tiedTo2].isHere()
    ) {
      obj2 = QuestJs._w[rope.tiedTo1];
    } else if (
      !QuestJs._w[rope.tiedTo1].isHere() &&
      ...
      return QuestJs._io.failedmsg(
        'Which end of {nm:rope:the} do you want to {rope.detachVerb}?',
        {
          rope,
        },
      );
    ...
    return QuestJs._io.failedmsg(
      '{nv:rope:be:true} not {rope.attachedVerb} to {nm:obj2:the}.',
      {
        rope,
        obj2,
      },
  ...
  if (obj2 === rope.tiedTo1 && rope.tethered)
    return QuestJs._io.failedmsg(
      '{nv:char:can:true} not {rope.detachVerb} {nm:rope:the} from {nm:obj2:the}.',
      { char, rope, obj2 },
    );

  QuestJs._io.msg(
    `{nv:char:${rope.detachVerb}:true} {nm:rope:the} from {nm:obj2:the}.`,
    {
      char,
      rope,
      obj2,
