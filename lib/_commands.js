...
QuestJs._commands = [
  ...
  new QuestJs._command.Cmd('Inv', {
    script() {
      ...
      QuestJs._io.msg(
        `${QuestJs._lang.inventory_prefix} ${QuestJs._tools.formatList(listOfOjects, {
  ...
  new QuestJs._command.Cmd('Eat', {
    npcCmd: true,
    rules: [QuestJs.cmdRules.isHeldNotWorn, QuestJs.cmdRules.canManipulate],
    objects: [{ scope: QuestJs._parser.isHeld, multiple: true, attName: 'ingest' }],
  ...
  new QuestJs._command.Cmd('SwitchOff2', {
    ...
    objects: [{ scope: QuestJs._parser.isHeld, multiple: true, attName: 'switchon' }],
  ...
  new QuestJs._command.Cmd('SwitchOff', {
    ...
    attName: 'switchoff',
    cmdCategory: 'SwitchOff',
    objects: [{ scope: QuestJs._parser.isHeld, multiple: true, attName: 'switchoff' }],
    defmsg: QuestJs._lang.cannot_switch_off,
  }),
  ...
  new QuestJs._command.Cmd('Open', {
    npcCmd: true,
    rules: [QuestJs.cmdRules.canManipulate, QuestJs.cmdRules.isHere],
    objects: [{ scope: QuestJs._parser.isPresent, multiple: true, attName: 'open' }],
  ...
  new QuestJs._command.Cmd('Close', {
    npcCmd: true,
    rules: [QuestJs.cmdRules.canManipulate, QuestJs.cmdRules.isHere],
    objects: [{ scope: QuestJs._parser.isPresent, multiple: true, attName: 'close' }],
  ...
  new QuestJs._command.Cmd('Lock', {
    npcCmd: true,
    rules: [QuestJs.cmdRules.canManipulate, QuestJs.cmdRules.isHere],
    objects: [{ scope: QuestJs._parser.isPresent, multiple: true, attName: 'lock' }],
  ...
  new QuestJs._command.Cmd('Unlock', {
    npcCmd: true,
    rules: [QuestJs.cmdRules.canManipulate, QuestJs.cmdRules.isHere],
    objects: [{ scope: QuestJs._parser.isPresent, multiple: true, attName: 'unlock' }],
  ...
  new QuestJs._command.Cmd('Eat', {
    npcCmd: true,
    rules: [QuestJs.cmdRules.canManipulate, QuestJs.cmdRules.isHeld],
    objects: [{ text: true }, { scope: QuestJs._parser.isPresent, attName: 'ingest' }],
    defmsg: QuestJs._lang.cannot_eat,
  }),
  ...
  new QuestJs._command.Cmd('TalkTo', {
    ...
    default(item) {
      return QuestJs._io.failedmsg(QuestJs._lang.cannot_talk_to, { char: game.player, item });
    },
  }),
  ...
  new QuestJs._command.Cmd('Topics', {
    ...
    objects: [{ scope: QuestJs._parser.isNpcAndHere }],
    default(item) {
      return QuestJs._io.failedmsg(QuestJs._lang.no_topics, { char: game.player, item });
    },
  }),
  ...
  new QuestJs._command.Cmd('Say', {
    script(arr) {
      const l = [];
      for (const key in QuestJs._w) {
        if (QuestJs._w[key].sayCanHear && QuestJs._w[key].sayCanHear(game.player, arr[0]))
      ...
      if (QuestJs._settings.givePlayerSayMsg)
        QuestJs._io.msg(
          `${QuestJs._lang.nounVerb(game.player, arr[0], true)}, '${QuestJs._tools.sentenceCase(
            arr[1],
          )}.'`,
        );
      for (const chr of l) {
        if (chr.sayQuestion && QuestJs._w[chr.sayQuestion].sayResponse(chr, arr[1]))
          return QuestJs._world.SUCCESS;
  ...
  new QuestJs._command.Cmd('FillWith', {
    rules: [QuestJs.cmdRules.canManipulate, QuestJs.cmdRules.isHeld],
    objects: [{ scope: QuestJs._parser.isHeld }, { scope: QuestJs._parser.isLiquid }],
    script(objects) {
  ...
  new QuestJs._command.Cmd('NpcFillWith', {
    ...
    script(objects) {
      ...
      if (!npc.npc)
        return QuestJs._io.failedmsg(QuestJs._lang.not_npc, { char: game.player, item: npc });
      objects.shift();
  ...
  new QuestJs._command.Cmd('TieTo', {
    ...
    script(objects) {
      return handleTieTo(game.player, objects[0][0], objects[1][0]);
    },
  }),
  ...
  new QuestJs._command.Cmd('Untie', {
    ...
    script(objects) {
      handleUntieFrom(game.player, objects[0][0]);
    },
  }),
  ...
  new QuestJs._command.Cmd('UntieFrom', {
    ...
    script(objects) {
      handleUntieFrom(game.player, objects[0][0], objects[1][0]);
    },
  }),
  ...
  new QuestJs._command.Cmd('UseWith', {
    // npcCmd:true,
    rules: [QuestJs.cmdRules.canManipulate, QuestJs.cmdRules.isHere],
    objects: [{ scope: QuestJs._parser.isPresent }, { scope: QuestJs._parser.isPresent }],
    script(objects, matches) {
      const obj = objects[0][0];
  ...
  new QuestJs._command.Cmd('AskAbout', {
    ...
    objects: [{ scope: QuestJs._parser.isNpcAndHere }, { text: true }, { text: true }],
  }),
  ...
  QuestJs._commands.push(
    new QuestJs._command.Cmd('DebugWalkThrough', {
      ...
      script(objects) {
        ...
        if (wt === undefined)
          return QuestJs._io.errormsg(`No walkthrough found called ${objects[0]}`);
        for (const el of wt) {
          if (typeof el === 'string') {
...
function handleFillWithLiquid(char, vessel, liquid) {
  ...
  if (!vessel.isAtLoc(char.name))
    return QuestJs._io.failedmsg(QuestJs._lang.not_carrying, { char, item: obj });
...
function handlePutInContainer(char, objects) {
  ...
  if (!container.container)
    return QuestJs._io.failedmsg(QuestJs._lang.not_container, { char, container });
  ...
  for (const obj of objects[0]) {
    ...
    if (flag) {
      if (!obj.isAtLoc(char.name)) {
        QuestJs._io.failedmsg(QuestJs._tools.prefix(obj, multiple) + QuestJs._lang.not_carrying, {
          char,
          item: obj,
        });
      } else {
    ...
    if (flag) {
      if (!obj.isAtLoc(container.name)) {
        QuestJs._io.failedmsg(
          QuestJs._tools.prefix(obj, multiple) + QuestJs._lang.not_inside(container, obj),
        );
      } else {
...
const handleTieTo = function (char, rope, obj2) {
  if (!rope.rope) return QuestJs._io.failedmsg('You cannot attach that to anything.', { rope });
  if (!obj2.attachable)
  ...
  QuestJs._io.msg(`{nv:char:${rope.attachVerb}:true} {nm:rope:the} to {nm:obj2:the}.`, {
    char,
    rope,
    obj2,
  });
...
const handleUntieFrom = function (char, rope, obj2) {
  if (rope !== QuestJs._w.rope)
    return QuestJs._io.failedmsg('You cannot attach that to - or detach it from - anything.', {
      rope,
    });
  if (obj2 === undefined) {
    // obj2 not set; can we guess it?
    if (!rope.tiedTo1 && !rope.tiedTo2)
      return QuestJs._io.failedmsg('{nv:rope:be:true} not {rope.attachedVerb} to anything.', {
        rope,
      });
    if (rope.tiedTo1 && !rope.tiedTo2) {
      ...
      return QuestJs._io.failedmsg('Which end of {nm:rope:the} do you want to {rope.detachVerb}?', {
        rope,
      });
    }
  } else if (rope.tiedTo1 !== obj2.name && rope.tiedTo2 !== obj2.name) {
    return QuestJs._io.failedmsg('{nv:rope:be:true} not {rope.attachedVerb} to {nm:obj2:the}.', {
      rope,
      obj2,
    });
  }
  ...
  QuestJs._io.msg(`{nv:char:${rope.detachVerb}:true} {nm:rope:the} from {nm:obj2:the}.`, {
    char,
    rope,
    obj2,
  });
