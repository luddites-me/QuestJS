...
tp.text_processors.objectsLinks = function(arr, params) {
  ...
  return formatList(objArr, {article:INDEFINITE, lastJoiner:QuestJs.LANG.list_and, modified:true, nothing:QuestJs.LANG.list_nothing, loc:game.player.loc})
}
...
function getDisplayAlias(obj,art=INDEFINITE){
	return QuestJs.LANG.getName(obj,{article:art})
}
