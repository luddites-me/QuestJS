...
function handleObjLnkClick(cmd,el,verb,objAlias){
	parser.QuestJs._io.msg("handleObjLnkClick:  Handling object link click . . .")
	parser.QuestJs._io.msg("cmd: "+cmd)
	parser.QuestJs._io.msg("verb: "+verb)
	parser.QuestJs._io.msg("objAlias: "+objAlias)
	parser.QuestJs._io.msg("Sending to enterButtonPress . . .")
...
function switchDropdownVerb(el, newVerb, objName){
	...
	//parser.QuestJs._io.msg(`Replaced '${oldVerb}' on ${objName} with '${newVerb}'.`)
}
...
function disableExistingObjectLinks(bool=false){
	...
	//parser.QuestJs._io.msg("running disableExistingObjectLinks!")
