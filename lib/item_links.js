...
QuestJs._tp.text_processors.objectsLinks = function(arr, params) {
  ...
  return QuestJs._tools.formatList(objArr, {article:QuestJs._consts.INDEFINITE, lastJoiner:QuestJs._lang.list_and, modified:true, nothing:QuestJs._lang.list_nothing, loc:game.player.loc})
}
