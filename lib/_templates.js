  ...
  const res = $.extend({
    ...
    examineAddendum:function() {
      ...
      if (this.locs.length === 1) {
        if (obj1 && obj2) return processText(QuestJs._lang.examineAddBothEnds, {rope:this, obj1:obj1, obj2:obj2})
        if (obj1) return processText(QuestJs._lang.rope_examine_attached_one_end, {rope:this, obj1:obj1})
        if (obj2) return processText(QuestJs._lang.rope_examine_attached_one_end, {rope:this, obj1:obj2})
