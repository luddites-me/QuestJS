...
function respond(params, list, func) {
  ...
  if (response.QuestJs._io.msg) {
    if (params.actor) {
      params.actor.QuestJs._io.msg(response.QuestJs._io.msg, params)
    }
    else {
      QuestJs._io.msg(response.QuestJs._io.msg, params)
    }
  }
  if (!response.script && !response.QuestJs._io.msg && !response.failed) {
...
util.cannotUse = function(char, dir) {
  ...
  QuestJs._io.msg(this.QuestJs._io.msg ? this.QuestJs._io.msg : QuestJs._lang.try_but_locked, tpParams)
  return false
}
