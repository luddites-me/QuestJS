...
QuestJs._create.createRoom('royal_bedroom', {
  desc:
    'The royal bedroom got rather damaged in the goblin raids. But the bed looks okay.',
...
QuestJs._create.createRoom('great_hall', {
  desc:
    'The great hall saw a lot of fighting when the goblins attacked, and is in a sorry state.',
