...
QuestJs._create.createRoom('lounge', {
  ...
  south: new QuestJs._create.Exit('hall'),
  mapColour: 'red',
  mapWidth: 45,
  mapHeight: 45,
});
...
QuestJs._create.createRoom('kitchen', {
  ...
  north: new QuestJs._create.Exit('dining_room'),
  east: new QuestJs._create.Exit('hall'),
});
...
QuestJs._create.createRoom('dining_room', {
  ...
  west: new QuestJs._create.Exit('garden_east', {
    mapOffsetY: -1,
    mapDrawBase: function (fromRoom, toRoom) {
      return (
        map.bezier(
          fromRoom,
          [
...
QuestJs._create.createRoom('hall', {
  desc: 'The hall is boring, the author really needs to put stuff in it.',
  up: new QuestJs._create.Exit('landing'),
  west: new QuestJs._create.Exit('kitchen'),
  north: new QuestJs._create.Exit('lounge'),
  east: new QuestJs._create.Exit('street_middle'),
  south: new QuestJs._create.Exit('conservatory', { mapOffsetX: -0.5 }),
  mapWidth: 25,
});
...
QuestJs._create.createRoom('shed', {
  ...
  north: new QuestJs._create.Exit('garden_east', { mapOffsetX: -0.5 }),
});
...
QuestJs._create.createRoom('landing', {
  desc: 'The lounge is boring, the author really needs to put stuff in it.',
  down: new QuestJs._create.Exit('hall'),
  west: new QuestJs._create.Exit('bedroom'),
});

QuestJs._create.createRoom('bedroom', {
  desc:
    'The lounge is boring, the author really needs to put stuff in it. There is a portal you go go in.',
  east: new QuestJs._create.Exit('landing'),
  in: new QuestJs._create.Exit('glade'),
});

QuestJs._create.createRoom('street_middle', {
  desc: 'The lounge is boring, the author really needs to put stuff in it.',
  west: new QuestJs._create.Exit('hall'),
  north: new QuestJs._create.Exit('street_north'),
  south: new QuestJs._create.Exit('street_south'),
  mapDrawBase: function () {
    return map.rectRoom(
      this,
      [
