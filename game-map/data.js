...
QuestJs._create.createRoom("dining_room", {
  ...
  west:new QuestJs._create.Exit('garden_east', {mapOffsetY:-1,  mapDrawBase:function(fromRoom, toRoom) {
...
QuestJs._create.createItem("Lara", QuestJs._npc.NPC(true), {
  ...
  properNoun:true,
  agenda:['walkRandom'],
  mapDrawBase:function() { return map.rectangle(QuestJs._w[this.loc], [[-5,-5], [10, 10]], 'fill:red;stroke:black') }
})
...
QuestJs._create.createItem("Kyle", QuestJs._npc.NPC(false), {
  ...
  properNoun:true,
  agenda:['walkRandom'],
  mapDrawBase:function() { return map.rectangle(QuestJs._w[this.loc], [[0,0], [10, 10]], 'fill:blue;stroke:black') }
})
...
QuestJs._create.createItem("Robot", QuestJs._npc.NPC(false), {
  ...
  mapDrawBase:function() { return map.rectangle(QuestJs._w[this.loc], [[-10,-10], [10, 10]], 'fill:silver;stroke:black') }
})
...
QuestJs._create.createRoom("garden_west", {
  ...
  south:new QuestJs._create.Exit('fairy_grotto', {mapOffsetY:-2, mapDrawBase:function(fromRoom, toRoom) {
...
QuestJs._create.createRoom("street_north", {
  ...
  afterFirstEnter:function() { QuestJs._w.street_middle.visited++ },
})
