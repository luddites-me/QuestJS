...
QuestJs._test.tests = function() {
  ...
  QuestJs._test.assertEqual('unarmed', game.player.getEquippedWeapon().alias)
  ...
  QuestJs._test.assertEqual('knife', game.player.getEquippedWeapon().alias)
  QuestJs._test.assertCmd("equip knife", "It already is.");
  QuestJs._test.assertCmd("drop knife", "You drop the knife.");
  QuestJs._test.assertEqual('unarmed', game.player.getEquippedWeapon().alias)
  QuestJs._test.assertEqual(undefined, game.player.equipped)
  ...
  QuestJs._test.assertEqual(30, game.player.getArmour())
  ...
  QuestJs._test.assertEqual([w.goblin], attack0.primaryTargets)
  ...
  QuestJs._test.assertEqual(40, w.goblin.health)
  ...
  QuestJs._test.assertEqual([w.goblin], attack1.primaryTargets)
  ...
  QuestJs._test.assertEqual(36, w.goblin.health)

  w.goblin.armour = 2
  QuestJs._random.prime(19)
  QuestJs._random.prime(4)
  attack1.resolve(w.goblin, true, 0)
  QuestJs._test.assertEqual(34, w.goblin.health)
  w.goblin.armour = 0
  w.goblin.health = 40
  ...
  QuestJs._test.assertEqual(25, w.goblin.health)
  ...
  QuestJs._random.prime(7)
  attack2.resolve(w.goblin, true, 0)
  QuestJs._test.assertEqual(14, w.goblin.health)
  w.goblin.armour = 0
  w.goblin.health = 40
  ...
  QuestJs._test.assertEqual([w.me], attack2a.primaryTargets)
  ...
  QuestJs._test.assertEqual(98, w.me.health)
  w.me.health = 100
  ...
  QuestJs._test.assertEqual(5, w.me.spellCasting)
  
  QuestJs._test.assertEqual('me', attack3.attacker.name)
  QuestJs._test.assertEqual(undefined, attack3.weapon)
  QuestJs._test.assertEqual([w.goblin, w.orc, w.snotling, w.rabbit], attack3.primaryTargets)
  ...
  QuestJs._test.assertEqual(33, w.goblin.health)
  ...
  QuestJs._random.prime(3)
  attack3.resolve(w.goblin, true, 0)
  QuestJs._test.assertEqual(19, w.goblin.health)
  //attack3.output(40)
  ...
  QuestJs._test.assertCmd('attack goblin', ['You attack the goblin.', /A hit/, 'Damage: 15', 'Health now: 25'])
  QuestJs._test.assertEqual(25, w.goblin.health)
  ...
  QuestJs._test.assertCmd('learn fireball', ['You do not have anything you can learn <i>Fireball</i> from.'])
  ...
  QuestJs._test.assertEqual(["Double attack", "Fireball"], game.player.skillsLearnt) 
  ...
  QuestJs._random.prime(4)
  QuestJs._test.assertCmd('cast fireball', ['You cast <i>Fireball</i>.', 'The room is momentarily filled with fire.', 'The goblin reels from the explosion.', 'Damage: 16', 'Health now: 24', 'The orc reels from the explosion.', 'Damage: 4', 'Health now: 56', 'The snotling ignores it.', 'The rabbit ignores it.'])
  w.goblin.health = 40
  w.orc.health = 60
  ...
  QuestJs._test.assertCmd('attack goblin', ['You cast <i>Ice shard</i>.', 'A shard of ice jumps from your finger to the goblin!', 'Damage: 10', 'Health now: 30'])
  w.goblin.health = 40
  skillUI.getSkillFromButtons = oldgetSkillFromButtons
  QuestJs._random.prime(19)
  QuestJs._random.prime(4)
  QuestJs._random.prime(7)
  QuestJs._random.prime(9)
  QuestJs._test.assertCmd('cast Ice shard at goblin', ['You cast <i>Ice shard</i>.', 'A shard of ice jumps from your finger to the goblin!', 'Damage: 10', 'Health now: 30'])
  w.goblin.health = 40
  skillUI.getSkillFromButtons = oldgetSkillFromButtons
  ...
  QuestJs._test.assertCmd('cast lightning bolt', ['You need a target for the spell <i>Lightning bolt</i>.'])
  ...
  QuestJs._random.prime(4)
  QuestJs._random.prime(7)
  QuestJs._test.assertCmd('attack goblin', ['You cast <i>Lightning bolt</i>.', 'A lightning bolt jumps from your out-reached hand to the goblin!', 'Damage: 20', 'Health now: 20', 'A smaller bolt jumps your target, but entirely misses the orc!', 'A smaller bolt jumps your target to the snotling!', 'Damage: 11', 'Health now: 9'])
  w.goblin.health = 40
  w.snotling.health = 20
  
  QuestJs._random.prime(4)
  QuestJs._test.assertCmd('attack goblin', ['You cast <i>Lightning bolt</i>.', 'A lightning bolt jumps from your out-reached hand to the goblin, fizzling out before it can actually do anything.'])
  ...
  QuestJs._test.assertEqual([w.me], attack2b.primaryTargets)
  ...
  QuestJs._test.assertEqual(94, w.me.health)
  ...
  QuestJs._test.assertEqual(79, w.me.health)
  ...
  QuestJs._test.assertEqual(79, w.me.health)
  QuestJs._test.assertEqual("A shard of ice jumps from the goblin's finger to you, but the ice amulet protects you, and you take no damage.", attack2d.report[5].t)
  ...
  QuestJs._test.assertCmd('drop spellbook', ['You drop the spellbook.'])
  QuestJs._test.assertEqual([], game.player.activeEffects)
  QuestJs._test.assertCmd('cast stoneskin', ['You cast the <i>Stoneskin</i> spell.', 'Your skin becomes as hard as stone - and yet still just as flexible.'])

  QuestJs._test.assertEqual(['Stoneskin'], game.player.activeEffects)
  QuestJs._test.assertCmd('cast steelskin', ['You cast the <i>Steelskin</i> spell.', 'Your skin becomes as hard as steel - and yet still just as flexible.', 'The <i>Stoneskin</i> spell terminates.'])
  QuestJs._test.assertEqual(['Steelskin'], game.player.activeEffects)
  ...
  QuestJs._test.assertEqual(2, game.player.countdown_Steelskin)
  QuestJs._test.assertCmd('z', ['You wait one turn.'])
  QuestJs._test.assertEqual(1, game.player.countdown_Steelskin)
  QuestJs._test.assertCmd('z', ['You wait one turn.', 'The <i>Steelskin</i> spell terminates.'])
  QuestJs._test.assertEqual(undefined, game.player.countdown_Steelskin)
  QuestJs._test.assertEqual([], game.player.activeEffects)
  QuestJs._test.assertCmd('z', ['You wait one turn.'])
  ...
  QuestJs._test.assertCmd('cast unlock', ['You cast the <i>Unlock</i> spell.', 'The door to the south unlocks.'])
  QuestJs._test.assertCmd('cast unlock', ['You cast the <i>Unlock</i> spell.', 'There are no locked doors.'])
  ...
  QuestJs._test.assertCmd('cast commune on rabbit', ['You cast <i>Commune with animal</i>.', 'You can now talk to the rabbit for a short time.'])
  QuestJs._test.assertCmd('talk to rabbit', [/You say \'Hello,\' to the rabbit/, /Fading away bunny/])
