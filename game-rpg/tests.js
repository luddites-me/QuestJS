...
QuestJs._test.tests = function() {
  ...
  QuestJs._game.player.modifyOutgoingAttack = function(attack) { attack.offensiveBonus += 2 }
  ...
  QuestJs._test.assertEqual([QuestJs._w.goblin, QuestJs._w.orc, QuestJs._w.snotling, QuestJs._w.rabbit], attack3.primaryTargets)
  ...
  const attack2b = Attack.createAttack(QuestJs._w.goblin, QuestJs._game.player, skills.findName('Ice shard'))
  ...
  const attack2c = Attack.createAttack(QuestJs._w.goblin, QuestJs._game.player, skills.findName('Psi-blast'))
  ...
  const attack2d = Attack.createAttack(QuestJs._w.goblin, QuestJs._game.player, skills.findName('Ice shard'))
  QuestJs._random.prime(19)
