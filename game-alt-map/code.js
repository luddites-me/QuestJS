...
quest.create('Charm for Tary', [
  {
    text:
      "Tary has asked me to find her a petro-charm; I should try Madame Rel's Little Shop of Wonders on the Wheat Road.",
  },
  {
    text:
      'Tary has asked me to find her a petro-charm; I have found one, I need to give it to her.',
  },
]);

QuestJs._util.openingTimes = function () {
  if (QuestJs._util.isAfter('1700'))
    return QuestJs._io.falsemsg('The business is now closed.');
  if (!QuestJs._util.isAfter('0800'))
    return QuestJs._io.falsemsg('The business closed until eight.');
  return true;
};
