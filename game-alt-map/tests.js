...
test.tests = function() {
  ...
  test.assertEqual("It is 11 Marisi, 1374, 1:46 am", QuestJs._text.processText("It is {dateTime}"))
  game.elapsedTime += 8 * 60 * 60
  test.assertEqual("It is 11 Marisi, 1374, 9:46 am", QuestJs._text.processText("It is {dateTime}"))
