...
QuestJs._create.createItem('Xsansi', QuestJs._npc.NPC(true), {
  isAtLoc: function (loc, situation) {
    ...
    return (
      isOnShip() && (situation === QuestJs._world.PARSER || situation === QuestJs._world.SIDE_PANE)
    );
  },
  properName: true,
  ...
  satellites: 6,
  crewStatusTemplate:
    "'Crew member {nms:actor} designation is: {param:actor:specialisation}. {pa:actor:true} current status is: {status}.{ifNot:actor:loc:nowhere: {pa:actor:true} current location is@@@colon@@@ {nm:room:the}.}'",
  currentPlanet: -1,
  ...
  askOptions: [
...

    {
      ...
      script: function () {
        ...
        for (let npc of NPCS)
          QuestJs._io.msg(
            QuestJs._text.processText(QuestJs._w.Xsansi.crewStatusTemplate, {
              actor: npc,
              room: QuestJs._w[npc.loc],
            }),
          );
      },
    },

    {
      ...
      script: function () {
        ...
        if (QuestJs._w.Xsansi.currentPlanet < 3) {
          QuestJs._io.msg(
            QuestJs._text.processText(QuestJs._w.Xsansi.crewStatusTemplate, {
              actor: QuestJs._w.Kyle,
              room: QuestJs._w[QuestJs._w.Kyle.loc],
            }),
          );
...

    {
      ...
      script: function () {
        ...
        if (QuestJs._w.Xsansi.currentPlanet < 3) {
          QuestJs._io.msg(
            QuestJs._text.processText(QuestJs._w.Xsansi.crewStatusTemplate, {
              actor: QuestJs._w.Aada,
              room: QuestJs._w[QuestJs._w.Aada.loc],
            }),
          );
...

    {
      ...
      script: function () {
        ...
        if (QuestJs._w.Xsansi.currentPlanet < 3) {
          QuestJs._io.msg(
            QuestJs._text.processText(QuestJs._w.Xsansi.crewStatusTemplate, {
              actor: QuestJs._w.Ha_yoon,
              room: QuestJs._w[QuestJs._w.Ha_yoon.loc],
            }),
          );
...

    {
      ...
      script: function () {
        ...
        if (QuestJs._w.Xsansi.currentPlanet < 3) {
          QuestJs._io.msg(
            QuestJs._text.processText(QuestJs._w.Xsansi.crewStatusTemplate, {
              actor: QuestJs._w.Ostap,
              room: QuestJs._w[QuestJs._w.Ostap.loc],
            }),
          );
...

    {
      ...
      script: function () {
        ...
        if (QuestJs._w.Xsansi.currentPlanet < 3) {
          let s =
            "'The ship's current status is: " +
            QuestJs._w.Xsansi.shipStatus +
            ' We currently have: ';
          for (let npc of NPCS) {
            if (npc.probeType) {
              s +=
          ...
          s +=
            QuestJs._w.Xsansi.seederPods +
            ' seeder pod' +
            (QuestJs._w.Xsansi.seederPods === 1 ? '' : 's') +
      ...
      script: function () {
        ...
        if (QuestJs._w.Xsansi.currentPlanet < 3) {
          ...
          if (list.length === 0) {
            ...
            QuestJs._io.msg(
              "'The following areas of the ship are not currently pressurised: " +
                list.join(', ') +
                ".'",
            );
          }
...

    {
      ...
      script: function () {
        ...
        if (QuestJs._w.Xsansi.currentPlanet > 2) {
          QuestJs._w.Xsansi.multiMsg(["'They're probes. What else is there to know?'"]);
        } else {
          QuestJs._io.msg(
...

    {
      name: 'planet',
      test: function (p) {
        return p.text.match(/this planet|this star|planet|star|the planet|the star/);
      },
      script: function () {
        ...
        if (QuestJs._w.Xsansi.currentPlanet < 3) {
          ...
          let s =
            "'We are currently in orbit around the planet " +
            planet.starName +
            planet.planet +
            "' she says. '";
...

    {
      ...
      script: function () {
        if (QuestJs._w.Xsansi.currentPlanet === 0) {
          ...
          if (QuestJs._w.Xsansi.currentPlanet < 3) {
            QuestJs._io.msg(
              "'We passed through the periphery of a class D meteor shower on the approach to " +
                PLANETS[1].starName +
                PLANETS[1].planet +
                ". I was able to modify the course of the ship to avoid the worst of the damage, but was constrained by the amount of fuel needed to complete the mission. The ship experienced damage to the upper forward and port areas.'",
            );
          } else {
...
QuestJs._create.createItem('Kyle', CREW(false), {
  ...
  desc:
    'Kyle is the computer expert, but also a good cook, and has volunteered for the role of chef. An Australian, he is slim, and below average height, with very short blonde hair, and green eyes.',
  ...
  reactions: function () {
    ...
    if (g === false && this.reactionToUndress < 2) {
      if (QuestJs._game.player.isFemale) {
        ...
        QuestJs._io.msg(
          "Kyle looks you up and down, and swallows nervously. 'Er... you're naked,' he says, trying, not to successfully, to stare.",
        );
        this.pause();
      }
  ...
  probeType: 'satellite',
  probesRemaining: 6,
  probeAction0: function () {
    QuestJs._io.msg('Kyle sits at the console, and logs in.');
  },
  probeAction3: function () {
    QuestJs._io.msg('Kyle watches the satellite as it goes into its prescribed orbit.');
  },
...
QuestJs._create.createItem('Ostap', CREW(false), {
  ...
  desc:
    'Ostap is a big guy; not fat, but broad and tall. He keeps his dark hair in a short ponytail.',
  baseOxygeUse: 9,
  ...
  askOptions: [
    {
      nameLost: 'lost probe',
      test: function (p) {
        return p.text.match(/(lost|destroyed) (bio|geo|bio-|geo-)?(probe|contact)/);
      },
      script: function () {
...
QuestJs._create.createItem('Aada', CREW(true), {
  ...
  geologyFlag2: false,
  desc:
    'Aada is a Finnish woman with features so ideal you suspect genetic engineering. Tall, with a perfect figure, she keeps her blonde hair short.',
  baseOxygeUse: 6,
  ...
  data: [
    ...
    [
      ...
      "'I thought it was going to be as dull as " +
        PLANETS[0].starName +
        ",' says Aada, 'but I think it is quite different. It's dead now, but I think there was life on it once.'|'Based on what?'|'It's just a hunch really, but some of the rocks... they look like ruined buildings.'",
...
QuestJs._create.createItem('Ha_yoon', CREW(true), {
  ...
  desc:
    'Ha-yoon is a well-respected Korean engineer, making her possibly the most important member of the crew for ensuring the ship gets back to Earth. She is the shortest of the crew, but perhaps the loudest. She has long, raven-black hair, that falls to her waist, and dark eyes.',
  baseOxygeUse: 4,
  ...
  reactions: function () {
    ...
    if (g === false && this.reactionToUndress < 2) {
      if (QuestJs._game.player.isFemale) {
        ...
        QuestJs._io.msg(
          "'Captain!' exclaims Ha-yoon when she sees you naked. 'I'm sure we don't need to see {i:that}!'",
        );
      }
      this.pause();
      this.reactionToUndress = 2;
