QuestJs._tp.addDirective('stasis_pod_status', (arr, params) =>
  QuestJs._w.stasis_bay.tpStatus(),
);
...
QuestJs._tp.addDirective('table_desc', (arr, params) =>
  QuestJs._w.canteen_table.tpDesc(),
);
