...
QuestJs._command.findCmd('MetaHelp').script = function() {
  ...
  if (w.Xsansi.currentPlanet !== 0) QuestJs._io.metamsg("{color:red:HELP VACUUM}: How to handle the cold vacuum of space");
  if (w.alienShip.status > 0) QuestJs._io.metamsg("{color:red:HELP DOCKING}: How to dock with another ship");
