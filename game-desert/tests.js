...
QuestJs._test.tests = function() {
  ...
  QuestJs._test.assertEqual(70, QuestJs._parser.scoreObjectMatch("flashlight", QuestJs._w.flashlight, ""));
  ...
  QuestJs._test.assertEqual(60, QuestJs._parser.scoreObjectMatch("torch", QuestJs._w.flashlight, ""));
  QuestJs._test.assertEqual(70, QuestJs._parser.scoreObjectMatch("glass cabinet", QuestJs._w.glass_cabinet, ""));
  ...
  QuestJs._test.assertEqual("You", QuestJs._lang.getName(QuestJs._w.me, {article:QuestJs._consts.INDEFINITE, capital:true}));
  ...
  QuestJs._test.assertEqual("Simple text: yes", QuestJs._text.processText("Simple text: {ifMoreThan:player:someOddAtt:50:yes:no}"));
  QuestJs._test.assertEqual("Simple text: no", QuestJs._text.processText("Simple text: {ifLessThan:player:someOddAtt:50:yes:no}"));
  QuestJs._test.assertEqual("Simple text: ", QuestJs._text.processText("Simple text: {ifLessThan:player:someOddAtt:50:yes}"));
  ...
  QuestJs._test.assertEqual("Kyle is your bear.", QuestJs._text.processText("{nv:Kyle:be} {pa:me} bear."));
  ...
  QuestJs._test.assertEqual("Kyle is a bear.", QuestJs._text.processText("{Kyle:alias} is a bear."));
  QuestJs._test.assertEqual("You have $10.", QuestJs._text.processText("You have ${show:me:money}."));
  ...
  QuestJs._test.assertCmd("e", ["You head east.", "The kitchen", "A clean room, a clock hanging on the wall. There is a sink in the corner.", "You can see a big kitchen table (with a jug on it), a camera, a garage door and a trapdoor here.", "You can go north or west.", "A fresh smell here!"]);
  ...
  QuestJs._test.assertCmd("look", ["The kitchen", "A clean room, a clock hanging on the wall. There is a sink in the corner.", "You can see a big kitchen table (with two bricks and a jug on it), a camera, a garage door and a trapdoor here.", "You can go north or west."]);
  QuestJs._test.assertCmd("get the bricks", "You take two bricks.");
  QuestJs._test.assertCmd("get clock", "You take the clock.");
  QuestJs._test.assertCmd("look", ["The kitchen", "A clean room. There is a sink in the corner.", "You can see a big kitchen table (with a jug on it), a camera, a garage door and a trapdoor here.", "You can go north or west."]);
  QuestJs._test.assertCmd("drop clock", "You drop the clock.");
  QuestJs._test.assertCmd("look", ["The kitchen", "A clean room. There is a sink in the corner.", "You can see a big kitchen table (with a jug on it), a camera, a clock, a garage door and a trapdoor here.", "You can go north or west."]);
  ...
  QuestJs._test.assertCmd("drop all", ["Knife: You drop the knife.", "Underwear: You drop the underwear.", "Jeans: You drop the jeans.", "Shirt: You drop the shirt.", "Coat: You drop the coat.", "Jumpsuit: You're wearing it.", ]);
  ...
  QuestJs._test.assertCmd("d", ["You head down.", "The lounge", "A smelly room with an old settee and a tv.", "You can see a book, some boots, seven bricks, a cardboard box, a coin, a flashlight, a garage key, a glass cabinet (containing a jewellery box (containing a ring) and an ornate doll), Kyle (wearing a straw boater), a small key and a waterskin here.", "You can go east, south, up or west.",]);  
  ...
  QuestJs._test.assertCmd("e", ["You head east.", "The kitchen", "A clean room. There is a sink in the corner.", "You can see a big kitchen table (with a jug on it), a camera, a clock, a garage door, Kyle (wearing a straw boater) and a trapdoor here.", "You can go north or west."]);
  QuestJs._test.assertCmd("kyle,n", "Kyle tries the garage door, but it is locked.");
  QuestJs._test.assertCmd("kyle,get all", ["Clock: Kyle takes the clock.", "Trapdoor: Kyle can't take it.", "Camera: Kyle takes the camera.", "Big_kitchen_table: Kyle can't take it.", "Garage_door: Kyle can't take it.", "Jug: Kyle takes the jug."]);
  ...
  QuestJs._test.assertCmd("QuestJs._w", ["You head west.", "The garden", "Very overgrown. The garden backs onto a shop to the west, whilst the conservatory is east.", "You can see Arthur here.", "You can go east or west."]);
  ...
  QuestJs._test.assertCmd("QuestJs._w", ["You head west.", "The lift", "A curious lift.", "You can see a Button: G, a Button: 1 and a Button: 2 here.", "You can go east."]);
  ...
  QuestJs._test.assertCmd("QuestJs._w", ["You head west.", "The lift", "A curious lift.", "You can see a Button: G, a Button: 1 and a Button: 2 here.", "You can go east.", "The lift is out of order", "The dining room", "An old-fashioned room.", "You can see a brick, a chair and a glass cabinet (containing a jewellery box (containing a ring) and an ornate doll) here.", "You can go east, up or west."]);
  ...
  QuestJs._test.assertCmd("s", ["You head south.", "The conservatory", "A light airy room.", "You can see a broken chair and a crate here.", "You can go north or west."]);
  ...
  QuestJs._test.assertCmd("s", ["You head south.", "The conservatory", "A light airy room.", "You can see a broken chair here.", "You can go north or west."]);
  QuestJs._test.assertCmd("QuestJs._w", ["You head west.", "The garden", "Very overgrown. The garden backs onto a shop to the west, whilst the conservatory is east.", "You can see Arthur, a crate and Lara here.", "You can go east or west."]);
  QuestJs._test.assertCmd("QuestJs._w", ["You head west.", "The shop", "A funny little shop.", "You can go east."]);
