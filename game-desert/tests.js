...
QuestJs._test.tests = function() {
  ...
  QuestJs._test.assertEqual(70, QuestJs._parser.scoreObjectMatch("me", w.me, ""));
  QuestJs._test.assertEqual(-1, QuestJs._parser.scoreObjectMatch("me fkh", w.me, ""));
  QuestJs._test.assertEqual(-1, QuestJs._parser.scoreObjectMatch("xme", w.me, ""));
  QuestJs._test.assertEqual(70, QuestJs._parser.scoreObjectMatch("flashlight", w.flashlight, ""));
  ...
  QuestJs._test.assertEqual(60, QuestJs._parser.scoreObjectMatch("torch", w.flashlight, ""));
  QuestJs._test.assertEqual(70, QuestJs._parser.scoreObjectMatch("glass cabinet", w.glass_cabinet, ""));
  ...
  QuestJs._test.assertEqual("you", QuestJs._lang.getName(w.me));
  QuestJs._test.assertEqual("You", QuestJs._lang.getName(w.me, {article:QuestJs._consts.INDEFINITE, capital:true}));
  ...
  QuestJs._test.assertEqual(1, w.Lara.getTopics().length);
  ...
  QuestJs._test.assertCmd("w", ["You head west.", "The garden", "Very overgrown. The garden backs onto a shop to the west, whilst the conservatory is east.", "You can see Arthur here.", "You can go east or west."]);
  ...
  QuestJs._test.assertCmd("w", ["You head west.", "The lift", "A curious lift.", "You can see a Button: G, a Button: 1 and a Button: 2 here.", "You can go east."]);
  ...
  QuestJs._test.assertCmd("w", ["You head west.", "The garden", "Very overgrown. The garden backs onto a shop to the west, whilst the conservatory is east.", "You can see Arthur, a crate and Lara here.", "You can go east or west."]);
  QuestJs._test.assertCmd("w", ["You head west.", "The shop", "A funny little shop.", "You can go east."]);
  w.me.money = 20
