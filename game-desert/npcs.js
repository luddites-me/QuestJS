...
QuestJs._create.createItem('Lucas', QuestJs._npc.NPC(false), {
  ...
  relationship: 0,
  examine:
    'Lucas is a tall, slender black guy, wearing a tight-fitting orange vest top and khaki shorts. He has spiky blonde hair.',
...
QuestJs._create.createItem('Emily', QuestJs._npc.NPC(true), {
  ...
  relationship: 0,
  examine:
    'Emily is a slim redhead, wearing a cropped wgite top and tiny demin shorts. Her long hair looks a little too red to be natural.',
...
QuestJs._create.createItem('Elijah', QuestJs._npc.NPC(false), {
  ...
  relationship: 0,
  examine:
    'Elijah looks to be in his forties. He is about average height, but looks quite muscular. He is wearing a black "Ramones" tee-shirt and faded jeans.',
...
QuestJs._create.createItem('Amy', QuestJs._npc.NPC(true), {
  ...
  relationship: 0,
  examine:
    'Amy is a slim oriental woman, with long black hair falling around her shoulders. She looks to be in her mid-thirties, maybe a little older. She is wearing a blushing pink top and black leggings.',
