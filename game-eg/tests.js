...
test.tests = function() {
  ...
  test.assertEqual(55, QuestJs._parser.scoreObjectMatch("me", w.Buddy, ""));
  test.assertEqual(-1, QuestJs._parser.scoreObjectMatch("me fkh", w.Buddy, ""));
  test.assertEqual(-1, QuestJs._parser.scoreObjectMatch("xme", w.Buddy, ""));
  test.assertEqual(60, QuestJs._parser.scoreObjectMatch("flashlight", w.flashlight, ""));
  ...
  test.assertEqual(55, QuestJs._parser.scoreObjectMatch("torch", w.flashlight, ""));
  test.assertEqual(60, QuestJs._parser.scoreObjectMatch("glass cabinet", w.glass_cabinet, ""));
  ...
  test.assertEqual("you", QuestJs._lang.getName(w.Buddy));
  test.assertEqual("You", QuestJs._lang.getName(w.Buddy, {article:INDEFINITE, capital:true}));
